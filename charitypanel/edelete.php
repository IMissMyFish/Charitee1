...
if($_POST['action']== "delete")
{
    ...
    include("../charities.php");
      ...
      $n1 = $_SESSION['pnum'];
      $_SESSION['trueid'] = $_SESSION['e_eid'][$n1];
      ...
      $sql = "DELETE FROM event WHERE eid = '".$_SESSION['trueid']."' AND cid = '".$_SESSION['result0'][0]."' ";
...
<body>
  ...
  <div id = "header">
    ...
    <div id = "mainBox">
      <h2>Are you sure you want to delete this event? All data will be lost!</h2>

...
if(isset($_POST['action']))
{
  ...
  if($_POST['action']=="list")
  {
    ...
    $sql = "INSERT into `volunteer` (`cid`, `name`, `description`, `date1`, `date2`) values('".$cid."', '".$name."','".$description."','".$date1."','".$date2."')";
...
<body>
  ...
  <div id = "mainBox">
      ...
      <form name = "master" action="" method = "post">
        <h2 id = "headTitle">Create a Volunteer Oppurtunity</h2>
        <div id = "inputSec" class = "textInput">
          <?php echo $nameErr ?>
          <input class = "auto" type="text" name="name" pattern = ".{1,50}" placeholder="Oppurtunity Name (1-50 characters)">
          <?php echo $descriptionErr?>
          <textarea readonly = "readonly" cols = "4" rows = "1" id = "counter"></textarea>
          <br>
          <input onkeyup="textCounter(this,'counter',255);" class = "auto" type="text" name="description"  pattern = ".{1,255}"  placeholder="Oppurtunity Description (1-255 characters)">


          <?php echo $date1Err ?>
          <input name="date1" placeholder="Beginning Date"  class="datepicker-here" data-position="right top"  data-language='en'   required>
          <?php echo $date2Err ?>

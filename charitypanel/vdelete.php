...
if($_POST['action']== "delete")
{
    ...
    include("../charities.php");
      ...
      $sql = "DELETE FROM volunteer WHERE vid = '".$_SESSION['trueid']."' AND cid = '".$_SESSION['result0'][0]."' ";
...
<body>
  ...
  <div id = "header">
    ...
    <div id = "mainBox">
      <h2>Are you sure you want to delete this oppurtunity? All data will be lost!</h2>
